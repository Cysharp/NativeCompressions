...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ZDICT_params_t"][::std::mem::size_of::<ZDICT_params_t>() - 12usize];
    ["Alignment of ZDICT_params_t"][::std::mem::align_of::<ZDICT_params_t>() - 4usize];
    ["Offset of field: ZDICT_params_t::compressionLevel"]
        [::std::mem::offset_of!(ZDICT_params_t, compressionLevel) - 0usize];
    ["Offset of field: ZDICT_params_t::notificationLevel"]
        [::std::mem::offset_of!(ZDICT_params_t, notificationLevel) - 4usize];
    ["Offset of field: ZDICT_params_t::dictID"]
        [::std::mem::offset_of!(ZDICT_params_t, dictID) - 8usize];
};
unsafe extern "C" {
