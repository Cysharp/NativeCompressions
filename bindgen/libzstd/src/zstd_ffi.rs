...
#[no_mangle]
pub unsafe extern "C" fn csbindgen_ZSTD_getErrorCode(
    functionResult: usize
) -> zstd::ZSTD_ErrorCode
{
    zstd::ZSTD_getErrorCode(
        functionResult
    )
}

#[no_mangle]
pub unsafe extern "C" fn csbindgen_ZSTD_getErrorString(
    code: zstd::ZSTD_ErrorCode
) -> *const c_char
{
    zstd::ZSTD_getErrorString(
        code
    )
}
