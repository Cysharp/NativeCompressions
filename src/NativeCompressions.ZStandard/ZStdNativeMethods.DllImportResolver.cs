...
{
    public static unsafe partial class ZStdNativeMethods
    {
		...
		static ZStdNativeMethods()
		{
			NativeLibrary.SetDllImportResolver(typeof(ZStdNativeMethods).Assembly, DllImportResolver);
		}
