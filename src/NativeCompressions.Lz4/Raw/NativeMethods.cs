...
namespace NativeCompressions.LZ4.Raw
{
    public static unsafe partial class NativeMethods
    {
        ...
        ///  @return : loaded dictionary size, in bytes (note: only the last 64 KB are loaded)
        /// </summary>
        [DllImport(__DllName, EntryPoint = "LZ4_loadDictSlow", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int LZ4_loadDictSlow(LZ4_stream_u* streamPtr, byte* dictionary, int dictSize);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "LZ4_attach_dictionary", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        public static extern LZ4_stream_u* LZ4_initStream(void* stateBuffer, nuint size);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "LZ4_attach_HC_dictionary", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "LZ4F_compressBegin_usingDict", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern nuint LZ4F_compressBegin_usingDict(LZ4F_cctx_s* cctx, void* dstBuffer, nuint dstCapacity, void* dictBuffer, nuint dictSize, LZ4F_preferences_t* prefsPtr);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "LZ4F_decompress_usingDict", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "LZ4F_createCDict", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern LZ4F_CDict_s* LZ4F_createCDict(void* dictBuffer, nuint dictSize);

        [DllImport(__DllName, EntryPoint = "LZ4F_freeCDict", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "LZ4F_compressFrame_usingCDict", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    ...
    [StructLayout(LayoutKind.Sequential)]
    public unsafe partial struct LZ4HC_match_t
    {
        public int off;
        public int len;
        public int back;
